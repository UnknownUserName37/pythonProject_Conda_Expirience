...
while True:
    ...
    while True:
        ...
        if (sum_profit // tupo) == 0:
            ...
            years = ((sum_profit - (och_tupo*10)) / och_tupo) #рассчёт бабок с учётом суммы начального депозита
            print("потерпи стока лет -> ", float(years), "у тя будет стока бабла -> ", float(tupo))
            break
